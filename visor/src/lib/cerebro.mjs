...
export const harness = datos.harness || { piezas: [], declarados: [], config: {} };
export const evaluacion = datos.evaluacion || { casos: 0, filas: [] };
export const telemetria = datos.telemetria || { eventos: 0, consultas: 0, por_origen: {}, reglas_mas_devueltas: [], reglas_con_hallazgos: [], ultimas_sin_resultado: [] };
